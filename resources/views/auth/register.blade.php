            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="id_juzgado" class="col-md-4 col-form-label text-md-right">{{ __('Juzgado') }}</label>

                            <div class="col-md-6">
                                <input id="id_juzgado" type="text" class="form-control" name="id_juzgado" required="">
                            </div>
                        </div>
